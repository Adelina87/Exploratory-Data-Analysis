...
# Plot 2  : create graph giving the scattering of Global Active Power by day on the given period
#Define the ouput device
png("plot2.png", width = 480, height = 480, units = "px")
with(DF_Final,plot(DateTime,Global_active_power_Num,type='l',xlab="",ylab="Global Active Power (kilowatts)"))
